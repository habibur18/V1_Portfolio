    ...
    <div id="aboutMe">
      ...
      <div id="resume" className="my-8 text-white mx-16">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://drive.google.com/file/d/1VTeD4qBPqlElKuWrDznffb9OTF_t9qiM/view" target="_blank" rel="noopener noreferrer" className="bg-green-800 text-white px-4 py-2 rounded-full flex items-center space-x-2 transition-all duration-300 transform hover:scale-105">
            <FontAwesomeIcon icon={faFileDownload} className="text-xl" />
